...
import com.example.techworld.model.dto.brand.BrandDTO;
import com.example.techworld.model.dto.model.ModelDTO;
import com.example.techworld.model.entity.BrandEntity;
import com.example.techworld.model.entity.ModelEntity;
import com.example.techworld.repository.BrandRepository;
...
public class BrandService {
    ...
    private BrandDTO mapBrand(BrandEntity brandEntity) {
        List<ModelDTO> models = brandEntity.getModels().stream().map(this::mapModel).toList();
