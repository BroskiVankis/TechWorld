...
public class TechworldSecurityExpressionHandler extends DefaultMethodSecurityExpressionHandler {

    private final OfferService offerService;

    public TechworldSecurityExpressionHandler(OfferService offerService) {
